# Deploy the pension-supplement contract to Stellar testnet, then write the contract
...
$Wasm = "target\wasm32v1-none\release\inventory_finance.wasm"
...
# 4. Write NEXT_PUBLIC_CONTRACT_ID into web\.env.local
